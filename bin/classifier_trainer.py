...
from neunet.trainer import BinaryClassifierTrainer
...
parser = argparse.ArgumentParser(
    prog="classifier_trainer",
    description="Trains a classification neural net",
    epilog="",
)
...
parser.add_argument(
    ...
    "--config",
    required=True,
    help="Path of config file, e.g. from working directory: bin/conf/classifier_test_config.yml",
)
...
def main(conf: TrainerConfig):
    ct = BinaryClassifierTrainer(conf)
    ct.run_trainer()
