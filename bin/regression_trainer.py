...
from neunet.trainer import RegressionTrainer
...
parser.add_argument(
    ...
    "--config",
    required=True,
    help="Path of config file, e.g. from working directory: bin/conf/regression_test_config.yml",
)
